# pizza-gpt
 criando bot com whats e chat-gpt

# Minhas anotações
[Tutorial](https://www.youtube.com/watch?v=lCR7Ssw0v-k&ab_channel=FelipeFontoura%40DevSamurai)

//correção de erro

[Venom](https://www.npmjs.com/package/venom-bot)

[envia uma msg para whats](https://api.whatsapp.com/send?phone=5583996555344)

[openai chat documentação](https://platform.openai.com/docs/api-reference/introduction?lang=node.js)

```Javascript
//ver versões de um pacote
npm view c versions
...
npm i --save-dev @types/venom-bot
...
//erro no redme, faltava instalar o docker compose para
//Criar um container
docker compose up
